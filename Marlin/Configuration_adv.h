 ...
 */
  ...
  #define MESH_MIN_X PROBING_MARGIN
  #define MESH_MIN_Y PROBING_MARGIN
  #define MESH_MAX_X (X_BED_SIZE - (PROBING_MARGIN + 40))
  #define MESH_MAX_Y (Y_BED_SIZE - (PROBING_MARGIN + 40))
#endif
